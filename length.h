...
// 
// To use this class, create a LengthFieldBuffer variable and associate 
// definitions with the fields.
// operations are provided to allow values to be associated with the 
// fields (Pack) and to fetch the values of fields (Unpack)
{  public:
